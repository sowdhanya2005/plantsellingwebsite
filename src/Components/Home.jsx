  ...
  return (
    <div>
      ...
      <p style={{ color:'white' }}>EliteEvents</p>
           ...
           <h1 style={{ fontSize:'45px' }}>Plants are all chemists, tirelessly assembling the molecules of the worls-Gray Snyder</h1>
...
<div className="products">
 ...
 <br></br>
        ...
        <button style={{ padding: '10px 30px', fontSize: '16px', backgroundColor:'SeaGreen' }} >Explore</button>
        </div>
