...
const Herbal = ({ handleAddToCart }) => {
  const herbalItems = [
    ...
    { name: 'Curcuma aromatica (Wild Turmeric)', image: im10, price: 60,uses:'It is primarily used for cosmetic purposes and is known to enhance skin glow. This herb possesses anti-inflammatory, antioxidant, and antibacterial properties, making it beneficial for various skin types, including acne-prone, dry, and pigmented skin.' },
  ];
